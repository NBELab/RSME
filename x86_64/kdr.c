...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdr /Users/elishai/Dropbox/1AFiles/NBEL G2/RSME/RSME_dis/x86_64/kdr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/elishai/Dropbox/1AFiles/NBEL G2/RSME/RSME_dis/mods/kdr.mod";
static const char* nmodl_file_text = 
  "TITLE K-DR channel\n"
